...
public class Support {
	...
	public static final String MAIN_CSS_URL = "view/application.css";

	public static final String JDK_PAGE_URL = "view/jdk.fxml";
	public static final String UNICODE_PAGE_URL = "view/converter.fxml";
